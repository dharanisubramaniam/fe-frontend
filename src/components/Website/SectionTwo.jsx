      ...
      <div className="sectionTwoWrapper">
        ...
        <div className="premiereProBasics__Container">
          ...
          <div className="premiereProBasics">
            <h1>Learn to Edit your videos like a pro</h1>
            <p>
              We provide you with a complete introduction to video creation and
              it's techniques in this short video course
            </p>
            <a
              className="linkHomePage free"
              href="https://www.youtube.com/watch?v=pnAIDUpADOM"
            >
              Start Now
            </a>
          </div>
